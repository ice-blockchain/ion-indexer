...
class IntegrityChecker : public td::actor::Actor {
  ...
  public:
    ...
    void got_block_handle(ion::validator::ConstBlockHandle handle);
    void got_min_mc_seqno(ion::BlockSeqno min_known_seqno);
    void got_oldest_mc_seqno_with_state(ion::BlockSeqno oldest_seqno_with_state);
