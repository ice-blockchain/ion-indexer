...
class BlockParser: public td::actor::Actor {
    td::Ref<ion::validator::BlockData> block_data_;
    ion::BlockSeqno mc_block_seqno_;
    td::Promise<std::vector<TransactionInfo>> promise_;
    MeasurementPtr measurement_;
public:
    BlockParser(td::Ref<ion::validator::BlockData> block_data, ion::BlockSeqno mc_block_seqno, td::Promise<std::vector<TransactionInfo>> promise, const MeasurementPtr& measurement)
...
void McBlockEmulator::parse_error(ion::BlockId blkid, td::Status error, MeasurementPtr measurement) {
...
void McBlockEmulator::block_parsed(ion::BlockId blkid, std::vector<TransactionInfo> txs, MeasurementPtr measurement) {
