...
struct ShardStateSnapshot {
    ion::BlockId blkid;
    ion::UnixTime timestamp;
    ion::LogicalTime logical_time;
...
private:
    ...
    void parse_error(ion::BlockId blkid, td::Status error, MeasurementPtr measurement);
    void block_parsed(ion::BlockId blkid, std::vector<TransactionInfo> txs, MeasurementPtr measurement);
