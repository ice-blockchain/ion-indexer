...
int main(int argc, char *argv[]) {
  ...
  td::OptionParser p;
  p.set_description("Emulate ION traces");
  ...
  p.add_option('\0', "testnet", "Use for testnet. It is used for correct detecting of .ion DNS entries (in testnet .ion collection has a different address)", [&]() {
