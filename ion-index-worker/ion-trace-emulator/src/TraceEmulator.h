...
struct TraceNode {
    ...
    ion::BlockSeqno mc_block_seqno;
    ion::BlockId block_id;
...
public:
    TraceEmulatorImpl(ion::BlockId block_id, EmulationContext& context,
    ...
    void emulate(td::Ref<vm::Cell> in_msg, block::StdAddress address, ion::LogicalTime lt, size_t depth,
...
public:
    ShardBlockEmulator(ion::BlockId block_id, EmulationContext& context, std::vector<EmulationMessage> in_msgs,
