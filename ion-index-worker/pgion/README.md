...
* ionhash: acts like a base64 string of size 44 bytes, but is stored in 32 bytes.
* ionaddr: acts like a ION address in raw-form string of size 66-67 bytes, but stored in 36 bytes.
...
* Configure and build: `cmake -DCMAKE_BUILD_TYPE=Release .. && make -j32 pgion`.
* Install binaries: `cd pgion && sudo make install`.
