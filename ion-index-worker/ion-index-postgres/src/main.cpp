...
int main(int argc, char *argv[]) {
  ...
  td::OptionParser p;
  p.set_description("Parse ION DB and insert data into Postgres");
  ...
  p.add_option('D', "db", "Path to ION DB folder", [&](td::Slice fname) { 
    db_root = fname.str();
  });
  ...
  p.add_checked_option('p', "port", "PostgreSQL port", [&](td::Slice value) {
    ...
    try{
      ...
      return td::Status::Error(ion::ErrorCode::error, "bad value for --port: not a number");
    }
  ...
  p.add_option('\0', "testnet", "Use for testnet. It is used for correct indexing of .ion DNS entries (in testnet .ion collection has a different address)", [&]() {
    testnet = true;
  });
  ...
  p.add_checked_option('f', "from", "Masterchain seqno to start indexing from", [&](td::Slice value) { 
    ...
    try {
      ...
      return td::Status::Error(ion::ErrorCode::error, "bad value for --from: not a number");
    }
    from_seqno = v;
    return td::Status::OK();
  });
  p.add_checked_option('\0', "to", "Masterchain seqno to end indexing", [&](td::Slice value) { 
    ...
    try {
      ...
      return td::Status::Error(ion::ErrorCode::error, "bad value for --to: not a number");
    }
    to_seqno = v;
    return td::Status::OK();
  });
  ...
  p.add_checked_option('\0', "max-data-depth", "Max data cell depth to store in latest account states", [&](td::Slice value) { 
    ...
    try {
      ...
      return td::Status::Error(ion::ErrorCode::error, "bad value for --max-data-depth: not a number");
    }
    max_data_depth = v;
    return td::Status::OK();
  });
  p.add_checked_option('\0', "max-active-tasks", "Max active reading tasks", [&](td::Slice fname) { 
    ...
    try {
      ...
      return td::Status::Error(ion::ErrorCode::error, "bad value for --max-active-tasks: not a number");
    }
    max_active_tasks = v;
    return td::Status::OK();
  });
  ...
  p.add_checked_option('\0', "max-queue-blocks", "Max blocks in insert queue", [&](td::Slice fname) { 
    ...
    try {
      ...
      return td::Status::Error(ion::ErrorCode::error, "bad value for --max-queue-blocks: not a number");
    }
  ...
  p.add_checked_option('\0', "max-queue-txs", "Max transactions in insert queue", [&](td::Slice fname) { 
    ...
    try {
      ...
      return td::Status::Error(ion::ErrorCode::error, "bad value for --max-queue-txs: not a number");
    }
    max_queue.txs_ = v;
    return td::Status::OK();
  });
  p.add_checked_option('\0', "max-queue-msgs", "Max messages in insert queue", [&](td::Slice fname) { 
    ...
    try {
      ...
      return td::Status::Error(ion::ErrorCode::error, "bad value for --max-queue-msgs: not a number");
    }
    max_queue.msgs_ = v;
    return td::Status::OK();
  });
  ...
  p.add_checked_option('\0', "max-insert-actors", "Number of parallel insert actors (default: 3)", [&](td::Slice fname) { 
    ...
    try {
      ...
      return td::Status::Error(ion::ErrorCode::error, "bad value for --max-insert-actors: not a number");
    }
    max_insert_actors = v;
    return td::Status::OK();
  });
  p.add_checked_option('\0', "max-batch-blocks", "Max blocks in batch", [&](td::Slice fname) { 
    ...
    try {
      ...
      return td::Status::Error(ion::ErrorCode::error, "bad value for --max-batch-blocks: not a number");
    }
  ...
  p.add_checked_option('\0', "max-batch-txs", "Max transactions in batch", [&](td::Slice fname) { 
    ...
    try {
      ...
      return td::Status::Error(ion::ErrorCode::error, "bad value for --max-batch-txs: not a number");
    }
    batch_size.txs_ = v;
    return td::Status::OK();
  });
  p.add_checked_option('\0', "max-batch-msgs", "Max messages in batch", [&](td::Slice fname) { 
    ...
    try {
      ...
      return td::Status::Error(ion::ErrorCode::error, "bad value for --max-batch-msgs: not a number");
    }
    batch_size.msgs_ = v;
    return td::Status::OK();
  });
  ...
  p.add_checked_option('\0', "max-queue-size", "Max size of insert queue", [&](td::Slice fname) { 
    ...
    try {
      ...
      return td::Status::Error(ion::ErrorCode::error, "bad value for --max-queue-size: not a number");
    }
    max_queue_size = v;
    return td::Status::OK();
  });
  ...
  p.add_checked_option('\0', "io-workers", "Scheduler IO workers (default: 1)", [&](td::Slice fname) { 
    ...
    try {
      ...
      return td::Status::Error(ion::ErrorCode::error, "bad value for --io-workers: not a number");
    }
    io_workers = v;
    return td::Status::OK();
  });
