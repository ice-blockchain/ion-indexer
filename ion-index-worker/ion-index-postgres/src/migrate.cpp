...
std::string set_version_query(const Version& version) {
  std::stringstream ss;
  ss << "create table if not exists ion_db_version ("
     << "id                INTEGER PRIMARY KEY CHECK (id = 1),"
     << "major             INTEGER NOT NULL, "
     << "minor             INTEGER NOT NULL, "
     << "patch             INTEGER NOT NULL);\n";

  ss << "INSERT INTO ion_db_version(id, major, minor, patch) "
...
void run_1_2_0_migrations(const std::string& connection_string, bool custom_types, bool dry_run) {
  ...
  LOG(INFO) << "Creating required types...";
  {
    ...
    if (custom_types) {
      exec_query("create extension if not exists pgion;");
    } else {
      exec_query("create domain ionhash as char(44);");
      exec_query("create domain ionaddr as varchar;");
    }
    ...
    exec_query("create type blockidext as (workchain integer, shard bigint, seqno integer, root_hash ionhash, file_hash ionhash);");
    ...
    exec_query("create type dex_transfer_details as (amount numeric, asset ionaddr, source ionaddr, destination ionaddr, source_jetton_wallet ionaddr, destination_jetton_wallet ionaddr);");
    ...
    exec_query("create type jetton_transfer_details as(response_destination ionaddr, forward_amount numeric, query_id numeric, custom_payload text, forward_payload text, comment text, is_encrypted_comment boolean);");
    exec_query("create type nft_mint_details as (nft_item_index numeric);");
    exec_query("create type nft_transfer_details as(is_purchase boolean, price numeric, query_id numeric, custom_payload text, forward_payload text, forward_amount numeric, response_destination ionaddr, nft_item_index numeric, marketplace varchar);");
    exec_query("create type peer_swap_details as(asset_in ionaddr, amount_in numeric, asset_out ionaddr, amount_out numeric);");
    exec_query("create type jetton_swap_details as (dex varchar, sender ionaddr, dex_incoming_transfer dex_transfer_details, dex_outgoing_transfer dex_transfer_details, peer_swaps peer_swap_details[], min_out_amount numeric);");
    exec_query("create type staking_details as (provider varchar, ts_nft varchar, tokens_burnt numeric, tokens_minted numeric);");
    exec_query("create type ion_transfer_details as (content text, encrypted boolean);");
    ...
    exec_query("create type evaa_supply_details as (sender_jetton_wallet varchar, recipient_jetton_wallet varchar, master_jetton_wallet varchar, master varchar, asset_id varchar, is_ion boolean);");
    ...
    exec_query("create type ionco_deploy_pool_details as (jetton0_router_wallet varchar, jetton1_router_wallet varchar, jetton0_minter varchar, jetton1_minter varchar, tick_spacing integer, initial_price_x96 numeric, protocol_fee integer, lp_fee_base integer, lp_fee_current integer, pool_active boolean);");
  }
  ...
  try {
    ...
    query += (
      ...
      "account ionaddr not null, "
      "hash ionhash not null, "
      "lt bigint not null, "
      ...
      "account_state_hash_before ionhash, "
      "account_state_hash_after ionhash, "
      "descr descr_type, "
      "aborted boolean, "
      "destroyed boolean, "
      ...
      "compute_vm_init_state_hash ionhash,"
      "compute_vm_final_state_hash ionhash,"
      ...
      "action_action_list_hash ionhash, "
      ...
      "split_info_this_addr ionaddr, "
      "split_info_sibling_addr ionaddr, "
      "primary key (hash, lt), "
    ...
    query += (
      ...
      "hash ionhash not null primary key, "
      "body text);"
    );
    ...
    query += (
      ...
      "account ionaddr not null primary key, "
      "account_friendly ionaddr, "
      "hash ionhash not null, "
      "balance numeric, "
      "balance_extra_currencies jsonb, "
      "account_status account_status_type, "
      "timestamp integer, "
      "last_trans_hash ionhash, "
    ...
    query += (
      ...
      "address ionaddr not null primary key, "
      "code_hash ionhash, "
      "domain varchar);\n"
    );
    ...
    query += (
      ...
      "tx_hash ionhash not null, "
      "tx_lt bigint not null, "
      "tx_now integer not null, "
      "tx_aborted boolean not null, "
      "mc_seqno integer, "
      "query_id numeric, "
      "nft_item_address ionaddr, "
      "nft_item_index numeric, "
      "nft_collection_address ionaddr, "
      "old_owner ionaddr, "
      "new_owner ionaddr, "
      "response_destination ionaddr, "
      "custom_payload text, "
    ...
    query += (
      ...
      "mintable boolean, "
      "admin_address ionaddr, "
      "jetton_content jsonb, "
      "jetton_wallet_code_hash ionhash, "
      "last_transaction_lt bigint, "
      "code_hash ionhash, "
      "data_hash ionhash);\n"
    );
    ...
    query += (
      ...
      "query_id numeric, "
      "owner ionaddr, "
      "jetton_wallet_address ionaddr, "
      "jetton_master_address ionaddr, "
      "amount numeric, "
      "response_destination ionaddr, "
      "custom_payload text, "
      "trace_id ionhash, "
    ...
    query += (
      ...
      "is_complete boolean, "
      "created_at bigint, "
      "marketplace_address ionaddr, "
      "nft_address ionaddr, "
      "nft_owner_address ionaddr, "
      "full_price numeric, "
      "marketplace_fee_address ionaddr, "
      "marketplace_fee numeric, "
      "royalty_address ionaddr, "
    ...
    query += (
      ...
      "trace_id ionhash not null primary key, "
      "external_hash ionhash, "
      "external_hash_norm ionhash, "
    ...
    query += (
      ...
      "trace_id ionhash not null, "
      "action_id ionhash not null, "
      "start_lt bigint, "
      "end_lt bigint, "
      "start_utime bigint, "
      "end_utime bigint, "
      "source ionaddr, "
      "source_secondary ionaddr, "
      "destination ionaddr, "
      "destination_secondary ionaddr, "
      "asset ionaddr, "
      "asset_secondary ionaddr, "
      "asset2 ionaddr, "
      "asset2_secondary ionaddr, "
      "opcode bigint, "
      "tx_hashes ionhash[], "
      "type varchar, "
      "ion_transfer_data ion_transfer_details, "
      "value numeric, "
      "amount numeric, "
      ...
      "ionco_deploy_pool_data ionco_deploy_pool_details, "
      "trace_end_lt bigint, "
      "trace_external_hash ionhash, "
      "trace_external_hash_norm ionhash, "
    ...
    query += (
      ...
      "nft_item_address ionaddr not null primary key, "
      "nft_item_owner ionaddr, "
      "domain varchar, "
      "dns_next_resolver ionaddr, "
      "dns_wallet ionaddr, "
    ...
    "create table if not exists vesting_contracts ("
      ...
      "vesting_sender_address ionaddr, "
      "owner_address          ionaddr, "
      "last_transaction_lt    bigint, "
      "code_hash              ionhash, "
      "data_hash              ionhash);\n"
    ...
    query += (
      ...
      "vesting_contract_address ionaddr not null, "
      "wallet_address           ionaddr not null, "
    ...
    query += (
      ...
      "code_hash ionhash not null primary key, "
      "methods bigint[]);\n"
    );
    ...
    query += (
      "create unlogged table if not exists ion_indexer_leader ("
      "id integer primary key check (id = 1),"
      "leader_worker_id varchar not null, "
      "last_heartbeat timestamptz not null, "
      "started_at timestamptz not null);\n"

      "insert into ion_indexer_leader (id, leader_worker_id, last_heartbeat, started_at)"
...
void run_1_2_1_migrations(const std::string& connection_string, bool dry_run) {
  ...
  LOG(INFO) << "Altering types...";
  {
    ...
    exec_query("alter type nft_transfer_details add attribute real_prev_owner ionaddr;");
    exec_query("create type coffee_create_pool_details as (amount_1 numeric, amount_2 numeric, initiator_1 ionaddr, initiator_2 ionaddr, provided_asset ionaddr, lp_tokens_minted numeric, pool_creator_contract ionaddr);");
    exec_query("create type coffee_staking_deposit_details as (minted_item_address ionaddr, minted_item_index numeric);");
    exec_query("create type coffee_staking_withdraw_details as (nft_address ionaddr, nft_index numeric, points numeric);");
  }
  ...
  try {
    ...
    query += "ALTER TABLE actions ADD COLUMN IF NOT EXISTS trace_external_hash_norm ionhash;\n";
    query += "ALTER TABLE traces ADD COLUMN IF NOT EXISTS external_hash_norm ionhash;\n";
...
void run_1_2_2_migrations(const std::string& connection_string, bool dry_run) {
  ...
  LOG(INFO) << "Altering types...";
  {
    ...
    exec_query("alter type nft_transfer_details add attribute marketplace_address ionaddr;");
...
void run_1_2_3_migrations(const std::string& connection_string, bool dry_run) {
  ...
  LOG(INFO) << "Altering types...";
  {
    ...
    exec_query("create type layerzero_send_details as (send_request_id numeric, msglib_manager varchar, msglib varchar, uln ionaddr, native_fee numeric, zro_fee numeric, endpoint ionaddr, channel ionaddr);");
    ...
    exec_query("create type layerzero_dvn_verify_details as (nonce numeric, status varchar, dvn ionaddr, proxy ionaddr, uln ionaddr, uln_connection ionaddr);");
...
void run_1_2_4_migrations(const std::string& connection_string, bool dry_run) {
  ...
  try {
    ...
    query += "ALTER TABLE nft_items ADD COLUMN IF NOT EXISTS real_owner ionaddr;";
...
void run_1_2_7_migrations(const std::string& connection_string, bool dry_run) {
  ...
  try {
    ...
    query += (
      ...
      "address              ionaddr not null primary key, "
      "token_name           varchar, "
      "bidder_address       ionaddr, "
      "bid                  numeric, "
      "bid_ts               integer, "
      "min_bid              numeric, "
      "end_time             integer, "
      "beneficiary_address  ionaddr, "
    ...
    query += "ALTER TABLE getgems_nft_auctions ADD COLUMN IF NOT EXISTS jetton_wallet ionaddr;\n";
    query += "ALTER TABLE getgems_nft_auctions ADD COLUMN IF NOT EXISTS jetton_master ionaddr;\n";
...
int main(int argc, char *argv[]) {
  ...
  td::OptionParser p;
  p.set_description("Create Postgres database for ION blockchain indexing and run migrations");
  ...
  p.add_option('\0', "custom-types", "Use pgion extension with custom types", [&]() {
    custom_types = true;
    LOG(WARNING) << "Using pgion extension!";
  });
