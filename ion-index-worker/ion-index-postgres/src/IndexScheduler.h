...
private:
  ...
  std::unordered_map<ion::BlockSeqno, td::Timer> timers_;
public:
...
private:
  ...
  void handle_missing_ta_state(ion::BlockSeqno next_seqno);
  void handle_valid_ta_state(ion::BlockSeqno last_state_seqno);
