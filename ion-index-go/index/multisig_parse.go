...
func (jt *JettonTransferBody) parseForwardPayload(payloadSlice *cell.Slice) {
	...
	case 0x25938561:
		jt.PayloadSumType = "IonDexSwap"
		jt.parseIonDexSwap(payloadSlice)
	default:
		jt.PayloadSumType = "Unknown"
	}
}

func (jt *JettonTransferBody) parseIonDexSwap(slice *cell.Slice) {
	defer func() {
		if recover() != nil {
			jt.PayloadSumType = "Unknown"
		}
	...
	jt.IonDexSwapBody = map[string]interface{}{
