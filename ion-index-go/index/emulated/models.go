...
type Action struct {
	...
	TonTransferData                  *actionTonTransferDetails                  `msgpack:"ion_transfer_data"`
	...
	ToncoDeployPoolData              *actionToncoDeployPoolDetails              `msgpack:"ionco_deploy_pool_data"`
