...
import (
	...
	emulated "github.com/ice-blockchain/ion-indexer/ion-index-go/index/emulated"
)
...
type JettonTransfer struct {
	...
	CustomPayload         *string          `json:"custom_payload"`
	DecodedCustomPayload  *json.RawMessage `json:"decoded_custom_payload" swaggertype:"object"`
	ForwardTonAmount      *string          `json:"forward_ion_amount"`
	ForwardPayload        *string          `json:"forward_payload"`
	DecodedForwardPayload *json.RawMessage `json:"decoded_forward_payload" swaggertype:"object"`
	TraceId               *HashType        `json:"trace_id"`
} // @name JettonTransfer
...
type ActionDetailsIonTransfer struct {
	Source          *AccountAddress    `json:"source"`
	Destination     *AccountAddress    `json:"destination"`
...
type ActionDetailsJettonMint struct {
	...
	ReceiverJettonWallet *AccountAddress `json:"receiver_jetton_wallet"`
	Amount               *string         `json:"amount"`
	TonAmount            *string         `json:"ion_amount"`
}
...
type ActionDetailsWionMint struct {
	Amount   *string         `json:"amount"`
	Receiver *AccountAddress `json:"receiver"`
}
...
type JettonTransferBody struct {
	...
	IonDexSwapBody   map[string]interface{} `json:"iondex_swap_body"`
}
...
func (ttm *TonTransferMessage) GetType() string { return "ion_transfer" }
