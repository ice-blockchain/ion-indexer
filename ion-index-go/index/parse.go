...
var EVAA_ION_ASSET_ID string = "0x1a4219fe5e60d63af2a3cc7dce6fec69b45c6b5718497a6148e7c232ac87bd8a"
...
func ParseRawAction(raw *RawAction) (*Action, error) {
	...
	case "contract_deploy":
		...
		act.Details = &details
	case "ion_transfer":
		var details ActionDetailsIonTransfer
		details.Source = raw.Source
		details.Destination = raw.Destination
		details.Value = raw.Value
	...
	case "jetton_swap":
		...
		// MinOutAmount common field in swaps but for now supported only in ionco swaps, thats why it should appear only for ionco for now
		if details.Dex != nil && *details.Dex == "ionco" {
	...
	case "stake_withdrawal_request":
		...
		details.PayoutNft = raw.StakingDataTsNft
		details.Asset = raw.Asset
		if details.Provider != nil && *details.Provider == "ionstakers" {
