...
ION_INDEXER_API_TITLE=TON Indexer
ION_INDEXER_WORKERS=4

ION_INDEXER_TON_HTTP_API_ENDPOINT=${ION_INDEXER_TON_HTTP_API_ENDPOINT}
...
cat <<EOF >> .env
TON_WORKER_DBROOT=${TON_WORKER_DBROOT:-/var/ion-work/db/}
