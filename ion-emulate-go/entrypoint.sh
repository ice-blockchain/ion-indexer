...
ion-emulate-go -pg "postgresql://${POSTGRES_USER}@${POSTGRES_HOST}:${POSTGRES_PORT}/${POSTGRES_DB}" -redis ${ION_INDEXER_EMULATE_REDIS_DSN:-'redis://localhost:6379'} $INDEX_ARGS $@
