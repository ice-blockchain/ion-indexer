...
import (
	...
	_ "github.com/ice-blockchain/ion-indexer/ion-emulate-go/docs"
	"github.com/ice-blockchain/ion-indexer/ion-emulate-go/models"
)
...
type TaskEnvelope struct {
	Type string `msgpack:"type"` // "trace" | "ionconnect"
...
func encodeTonconnectTask(enc *msgpack.Encoder, t TonConnectTraceTask) error {
	enc.UseArrayEncodedStructs(false) // map-encoding
	env := TaskEnvelope{Type: "ionconnect", Task: t}
	return enc.Encode(env)
}
...
// @title ION Emulate API
// @version 0.0.1
// @description	ION Emulate API provides an endpoint to emulate transactions and traces before committing them to the blockchain.
...
// @Summary Emulate trace for ION Connect format
// @Schemes
// @Description Emulate trace by composing external message from internal messages for ION Connect.
// @Tags emulate
// @Accept json
// @Produce json
// @Param   request     body    TonConnectEmulateRequest     true        "ION Connect Emulate Request"
// @Param	X-Actions-Version	header	string	false	"Supported actions version"
...
func main() {
	...
	var swagger_config = swagger.Config{
		Title:           "ION Emulate API - Swagger UI",
		Layout:          "BaseLayout",
		DeepLinking:     true,
