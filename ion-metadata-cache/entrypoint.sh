...
ion-metadata-cache --pg "postgresql://${POSTGRES_USER}@${POSTGRES_HOST}:${POSTGRES_PORT}/${POSTGRES_DB}" --pg-repl $ION_METADATA_CACHE_PG_REPL --redis $ION_METADATA_CACHE_REDIS -bind ":8000" $INDEX_ARGS $@
