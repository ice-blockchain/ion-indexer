...
const (
	healthKeyTraceEmulator   = "health:ion-trace-emulator"
	healthKeyEventClassifier = "health:event-classifier"
	healthKeyTTLTracker      = "health:ion-trace-ttl-tracker"
...
func healthzHandler(rdb *redis.Client) fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		response.Components["ion-trace-emulator"] = emulatorStatus
		...
		response.Components["ion-trace-ttl-tracker"] = ttlTrackerStatus
