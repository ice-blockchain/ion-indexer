...
class Asset:
    ...
    def __init__(self, is_ion: bool, jetton_address: Address | AccountId | str | None = None):
        self.is_ion = is_ion
    ...
    def __eq__(self, other):
        if isinstance(other, Asset):
            return self.is_ion == other.is_ion and self.jetton_address == other.jetton_address
        elif isinstance(other, str):
            return self.jetton_address.as_str().lower() == other.lower() or (self.is_ion and other.lower() == "ion")
        elif other is None:
            return self.is_ion == True and self.jetton_address is None

    def __hash__(self):
        return hash(self.is_ion) + hash(self.jetton_address)
